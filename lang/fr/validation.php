...
return [
    ...
    'gt.string' => 'Ce champ doit contenir plus de :value caractères.',
    ...
    'gte.string' => 'Ce champ doit contenir au moins :value caractères.',
    ...
    'custom' => [
        'password' => [
            'regex' => 'Le mot de passe doit contenir au moins un chiffre et des lettres majuscules ou minuscules.',
        ],
    ],
];
