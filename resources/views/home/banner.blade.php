 <!-- ============================ Hero Banner  Start================================== -->
 <div class="image-bottom half-header ext-bg" style="background:#d2eaff url(assets/img/banner-5.png) no-repeat;">
     <div class="container z-2">
         <div class="row justify-content-center">
             <div class="col-lg-9 col-md-11 col-sm-12">
                 <div class="inner-banner-text text-center mb-4">
                     ...
                     <h1><span class="font-normal">Find Your</span> Perfect Place.</h1>
                 </div>
                     ...
                     <div class="hero-search-content">
                         <div class="row">
                             ...
                             <div class="col-lg-2 col-md-3 col-sm-12">
                                 <div class="form-group">
                                     <button type="button" class="btn btn-main full-width">Search</button>
                                 </div>
                             </div>
