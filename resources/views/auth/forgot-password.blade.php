...
@section('title', config('app.name') . ' | ' . __('label.Forgot Password'))
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h2 class="ipt-title"> @lang('label.Forgot Password') </h2>
                    <span class="ipn-subtitle"> @lang('label.Forgot Password') </span>
                    ...
                    <div class="card border-0 rounded-4 p-xl-4 p-lg-4 p-md-4 p-3">
                        ...
                        <div class="simple-form">
                            <div class="form-header text-center mb-5">
                                ...
                                <p> @lang('auth.Forgot your password? No problem') </p>
                            </div>
                            @if (session('status'))
                            ...
                            <form  method="POST" action="{{ route('password.email') }}" >
                                ...
                                <div class="form-group">
                                    <button type="submit"
                                        class="btn btn-lg btn-main fw-medium full-width rounded-2">@lang('auth.Email Password Reset Link')</button>
                                </div>
