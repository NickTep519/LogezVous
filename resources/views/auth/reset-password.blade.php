...
@section('title', config('app.name') . ' | ' . __('auth.Password reset'))
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h2 class="ipt-title"> @lang('auth.Reset Password') </h2>
                    <span class="ipn-subtitle"> @lang('auth.Reset Password') </span>
                    ...
                    <div class="card border-0 rounded-4 p-xl-4 p-lg-4 p-md-4 p-3">
                        ...
                        <div class="simple-form">
                            <div class="form-header text-center mb-5">
                                ...
                                <h6> @lang('auth.Reset Password') </h6>
                            ...
                            <form method="POST" action="{{ route('password.store') }}" >
                                ...
                                <div class="form-floating mb-3">
                                    <input type="email" id="email" name="email"
                                        ...
                                        autocomplete="username" class="form-control" placeholder="name@example.com">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="password">@lang('label.New password')</label>
                                </div>
                                @error('password')
                                    <div class="alert alert-danger">
                                        {{ $message }}
                                ...
                                <div class="form-group">
                                    <button type="submit"
                                        class="btn btn-lg btn-main fw-medium full-width rounded-2">@lang('auth.Reset Password')</button>
                                </div>
