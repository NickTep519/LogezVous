        ...
        <nav id="navigation" class="navigation navigation-landscape">
            <div class="nav-header">
                ...
                <div class="mobile_nav">
                    <ul>
                        ...
                        <li>
                            <a href="home-5.html#" class="text-main" data-bs-toggle="offcanvas"
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                <ul class="nav-menu">
                    ...
                    <li class="active"><a href="home-5.html#">Home<span class="submenu-indicator"></span></a>
                        <ul class="nav-dropdown nav-submenu">
                            ...
                            <li><a href="home-10.html">Home Layout 10<span class="ms-2 label-new">New</span></a>
                            </li>
                            <li><a href="home-11.html">Home Layout 11<span class="ms-2 label-new">New</span></a>
                            </li>
                        ...
                        <ul class="nav-dropdown nav-submenu">
                            ...
                            <li><a href="JavaScript:Void(0);">Grid Layout<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                                    ...
                                    <li><a href="classical-layout-with-sidebar.html">Classical With Sidebar</a>
                                    </li>
                            ...
                            <li><a href="JavaScript:Void(0);">With Map Property<span
                    ...
                    <li><a href="JavaScript:Void(0);">Features<span class="submenu-indicator"></span></a>
                        <ul class="nav-dropdown nav-submenu">
                            <li><a href="JavaScript:Void(0);">Single Property<span
                                        class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                            ...
                            <li><a href="JavaScript:Void(0);">Agencies & Agents<span
                                        class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                    ...
                    @auth
                        <li>
                            <a href="JavaScript:Void(0);" data-bs-target="#login" class="fw-medium text-muted-2">
                    ...
                    @auth
                        <li class="add-listing">
                            <a href="submit-property.html" class="bg-main">
