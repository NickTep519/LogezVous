             ...
             <div class="row">
                 ...
                 <div class="col-lg-2 col-md-4">
                     <div class="footer-widget">
                         ...
                         <ul class="footer-menu">
                             <li><a href="home-5.html#">Apartment</a></li>
                             <li><a href="home-5.html#">My Houses</a></li>
                             <li><a href="home-5.html#">Restaurant</a></li>
                             <li><a href="home-5.html#">Nightlife</a></li>
                             <li><a href="home-5.html#">Villas</a></li>
                         </ul>
                     </div>
                 </div>
                 ...
                 <div class="col-lg-2 col-md-6">
                     <div class="footer-widget">
                         ...
                         <ul class="footer-menu">
                             <li><a href="home-5.html#">My Profile</a></li>
                             <li><a href="home-5.html#">My account</a></li>
                             <li><a href="home-5.html#">My Property</a></li>
                             <li><a href="home-5.html#">Favorites</a></li>
                             <li><a href="home-5.html#">Cart</a></li>
                         </ul>
                     </div>
                 </div>
                 ...
                 <div class="col-lg-3 col-md-6">
                     <div class="footer-widget">
                         ...
                         <a href="home-5.html#" class="other-store-link">
