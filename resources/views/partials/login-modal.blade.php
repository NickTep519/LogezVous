          ...
          <div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
              <div class="modal-content" id="registermodal">
                  ...
                  <div class="modal-body">
                      <h4 class="modal-header-title"> @lang('auth.SignIn') </h4>
                          ...
                          <form method="POST" action="{{ route('login') }}">
                              ...
                              <div class="form-group mb-3">
                                  <div class="d-flex align-items-center justify-content-between">
                                      ...
                                      <div class="flex-shrink-0 flex-first">
                                          <a href="{{ route('password.request') }}" class="link fw-medium"> @lang('label.Forgot Password') ?</a>
                                      </div>
                                      @endif
                      ...
                      <div class="social-login mb-3">
                          <ul>
                              <li><a href="home-5.html#" class="btn connect-fb"><i
                                          class="bi bi-facebook"></i>Facebook</a></li>
                              <li><a href="home-5.html#" class="btn connect-google"><i
