...
<script src="{{ asset('users/assets/js/rangeslider.js') }}"></script>
<script src="{{ asset('users/assets/js/select2.min.js') }}"></script>
<script src="{{ asset('users/assets/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('users/assets/js/slick.js') }}"></script>
<script src="{{ asset('users/assets/js/slider-bg.js') }}"></script>
