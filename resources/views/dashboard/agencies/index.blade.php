...
@section('title', config('app.name') . ' | ' . Auth::user()->name)
    ...
    <div class="col-lg-9 col-md-12">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h4>Your Current Package: <span class="pc-title text-main">Gold Package</span></h4>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="dashboard-stat widget-1">
                    ...
                    <div class="dashboard-stat-icon"><i class="bi bi-house-door"></i></div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="dashboard-stat widget-2">
                    ...
                    <div class="dashboard-stat-icon"><i class="bi bi-houses"></i></div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="dashboard-stat widget-3">
                    ...
                    <div class="dashboard-stat-icon"><i class="bi bi-tags"></i></div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="dashboard-stat widget-4">
                    ...
                    <div class="dashboard-stat-icon"><i class="bi bi-bookmark-star-fill"></i></div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="dashboard-stat widget-5">
                    ...
                    <div class="dashboard-stat-icon"><i class="bi bi-images"></i></div>
                </div>
            </div>
                ...
                <div class="submit-section">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 col-md-12">
                            <button class="btn btn-main rounded px-5" type="button">Save Changes</button>
                        </div>
